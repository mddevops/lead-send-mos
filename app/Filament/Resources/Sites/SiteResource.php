...
use App\Filament\Resources\Sites\RelationManagers\FormMappingsRelationManager;
...
class SiteResource extends Resource
{
    ...
    {
        return [
            FormMappingsRelationManager::class,
        ];
    }
    ...
    public static function getPages(): array
    {
        return [
            ...
            'manual-mapping' => ManualSiteMapping::route('/{record}/manual-mapping'),
        ];
    }
}
